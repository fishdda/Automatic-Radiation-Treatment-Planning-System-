 ...
 *
 */
class PrioritizedNlp : public TNLP
{
	OptimizationImpl *opt;
	//MatlabCommunicationManager *commMgr;
	//DummyMatlabComm *commMgr;
	int  getNumVar();
	int getNumConstraint();
	double fdiff,grdiff,gdiff,hdiff,jacdiff;
	//FileManager* f;

public:
  /** default constructor */
	PrioritizedNlp(int step,ProblemReps *prob);
  /** Current Step */

  /** default destructor */
  virtual ~PrioritizedNlp();
  ...
  //@}
 // void init(int step,ProblemReps *prob);
...
private:
  ...
  //@{
  //  PriortizedNlp();
  PrioritizedNlp(const PrioritizedNlp&);
  PrioritizedNlp& operator=(const PrioritizedNlp&);
